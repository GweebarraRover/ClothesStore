...
class BaseTableViewController: UITableViewController {
    ...
    func addNavBarButton() {
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "My basket", style: .plain, target: self, action: #selector(basketController))
    }
    
    func basketController() {
        let basketController = BasketTableViewController()
